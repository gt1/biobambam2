...
static int getDefaultMinLength() { return 0; }

int bamfilterlength(::libmaus2::util::ArgInfo const & arginfo)
{
	...
	int const minlength = arginfo.getValue<int>("minlength",getDefaultMinLength());
	...
	{
		if ( static_cast<int>(algn.getReferenceLength()) >= minlength )
...
int main(int argc, char * argv[])
{
	try
	{
		...
		return bamfilterlength(arginfo);
	}
